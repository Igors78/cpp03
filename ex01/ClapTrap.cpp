...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/13 08:15:47 by ioleinik          #+#    #+#             */
/*   Updated: 2021/11/13 10:30:40 by ioleinik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default ClapTrap (PARENT) constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string const name)
	: _name(name), _hitpoints(10), _energy_points(10), _attack_damage(0)
{
	std::cout << name << " ClapTrap (PARENT) constructor called" << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << this->_name << " ClapTrap (PARENT) destructor called"
			  << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_hitpoints <= amount)
	{
		...
		std::cout << this->_hitpoints << " points of damage and died!" << std::endl;
		this->_hitpoints = 0;
	}
	else
	{
...
ClapTrap &ClapTrap::operator=(ClapTrap const &right)
{
	if (this != &right)
	{
		...
		std::cout << "ClapTrap (PARENT) Assignment called" << std::endl;
	}
	return (*this);
}
